...
vec3 CalcDirLight(DirLight_ light, vec3 norm, vec3 viewDir){
  ...
  vec3 diffuse = light.diffuse *  texture(material.texture_diffused1, fs_in.TexCoord).rgb;
...
void main(){
    ...
    outFrag = texture(material.texture_diffused1, fs_in.TexCoord).rgb * dirLight.diffuse;
