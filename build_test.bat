...
set LIB_=libcmt.lib Kernel32.lib user32.lib gdi32.lib Opengl32.lib
set FILES=..\testOpenGL.cpp
...
rem )
    cl %COMPILE_FLAG% %DIRECTIVES_FLAG% -Fe:"TestOpenGl" %FILES% -link %LIB_% -DEBUG /subsystem:windows /FORCE:MULTIPLE /IGNORE:4006
