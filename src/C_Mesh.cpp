...
// 3. Read data using the offset obtained earlier
            matVal = (float*)((char*)ptr + (k*sizeof(GLfloat)*16));
            ...
            //if(matrixLocation != -1){
                ...
                if(matVal[0]!=0.0f){
                    ...
                    if(error == GL_INVALID_VALUE){
                        ...
                        printf("ProgramID is not an object or successfully linked or location is not correspond to uniform var, or data overflown over buffersize\n");                            
                    };                
                }
            //} else {
                GLenum error = glGetError();
